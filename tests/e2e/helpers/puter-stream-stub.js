 ...
 *
 * The production manifest passes chrome.runtime.getURL('src/bridge/puter.js')
 * to page-bridge.js, so tests patch that bundled file directly rather than
 * relying on a network route.
 */
