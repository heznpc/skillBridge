...
- **Provider boundary, core-owned lifecycle** — LMS-specific page detection, content roots, translation targets, lesson identity, and quiz safeguards live behind a minimal provider contract. Certification preflight still runs before initialization, while SPA navigation remains core-owned. See [docs/LMS_PROVIDERS.md](docs/LMS_PROVIDERS.md).
