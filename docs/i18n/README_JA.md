...
| 🇹🇼 中文繁體 (Chinese Traditional) | `zh-TW` | 570+ 項目 |
| 🇪🇸 Español (Spanish) | `es` | 570+ 項目 |
| 🇫🇷 Français (French) | `fr` | 570+ 項目 |
| 🇩🇪 Deutsch (German) | `de` | 570+ 項目 |
| 🇧🇷 Português (Brazilian) | `pt-BR` | 570+ 項目 |
| 🇷🇺 Русский (Russian) | `ru` | 570+ 項目 |
| 🇻🇳 Tiếng Việt (Vietnamese) | `vi` | 570+ 項目 |
