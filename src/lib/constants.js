...
const LOCALIZED_PAGE_LABELS = {
  ...
  nl: 'Deze pagina is al in de eigen taal gepubliceerd — SkillBridge heeft deze ongewijzigd gelaten.',
...
const LOCALIZED_MISMATCH_LABELS = {
  ...
  nl: 'Deze pagina is in een andere taal gepubliceerd. SkillBridge vertaalt officiële tekst niet opnieuw — gebruik de taalwisselaar van de site om de taal te wijzigen.',
...
const TUTOR_EXAM_LABELS = {
  ...
  nl: 'Ik kan niet rechtstreeks helpen met examenantwoorden, maar na het inleveren kan ik de concepten uitleggen.',
...
const TUTOR_GREETINGS = {
  ...
  nl: 'Hallo! Ik ben uw AI-leerassistent. Vraag me alles over deze cursus.',
...
const CHAT_PLACEHOLDERS = {
  ...
  nl: 'Stel een vraag over de cursusinhoud...',
...
const QUOTE_PLACEHOLDERS = {
  ...
  nl: 'Stel een vraag over deze tekst...',
  ja: '選択したテキストについて質問...',
  'zh-CN': '关于这段文字提问...',
  'zh-TW': '關於這段文字提問...',
...
const BANNER_UI = {
  ...
  nl: { prompt: 'Deze pagina vertalen naar', confirm: 'Vertalen', dismiss: 'Sluiten' },
...
const ONBOARDING_LABELS = {
  ...
  nl: {
    title: 'SkillBridge is klaar',
    body: 'Vertaal deze pagina in meer dan 30 talen en krijg tijdens het leren hulp van AI.',
    cta: 'Taal kiezen',
    dismiss: 'Begrepen',
  },
};
...
const DASHBOARD_LABELS = {
  ...
  empty: {
    ...
    nl: 'Nog niets — bezoek een les en uw voortgang verschijnt hier.',
...
const A11Y_LABELS = {
  toggleDark: {
    ...
    nl: 'Donkere modus in- of uitschakelen',
    ja: 'ダークモード切替',
    'zh-CN': '切换暗色模式',
    'zh-TW': '切換暗色模式',
    es: 'Modo oscuro',
...
const OFFLINE_LABELS = {
  unknown: {
    en: 'Offline — checking saved translations…',
    ko: '오프라인 — 저장된 번역을 확인하는 중…',
    id: 'Offline — memeriksa terjemahan tersimpan…',
    it: 'Offline — verifica delle traduzioni salvate…',
    nl: 'Offline — opgeslagen vertalingen controleren…',
    ja: 'オフライン — 保存済みの翻訳を確認中…',
    'zh-CN': '离线 — 正在检查已保存的翻译…',
    'zh-TW': '離線 — 正在檢查已儲存的翻譯…',
    es: 'Sin conexión — comprobando las traducciones guardadas…',
    fr: 'Hors ligne — vérification des traductions enregistrées…',
    de: 'Offline — gespeicherte Übersetzungen werden geprüft…',
    'pt-BR': 'Offline — verificando traduções salvas…',
    ru: 'Офлайн — проверяем сохранённые переводы…',
    vi: 'Ngoại tuyến — đang kiểm tra các bản dịch đã lưu…',
  },
  cacheOnly: {
    en: 'Offline — showing saved translations',
    ko: '오프라인 — 저장된 번역을 표시하는 중',
    id: 'Offline — menampilkan terjemahan tersimpan',
    it: 'Offline — visualizzazione delle traduzioni salvate',
    nl: 'Offline — opgeslagen vertalingen worden weergegeven',
    ja: 'オフライン — 保存済みの翻訳を表示中',
    'zh-CN': '离线 — 正在显示已保存的翻译',
    'zh-TW': '離線 — 正在顯示已儲存的翻譯',
    es: 'Sin conexión — mostrando las traducciones guardadas',
    fr: 'Hors ligne — affichage des traductions enregistrées',
    de: 'Offline — gespeicherte Übersetzungen werden angezeigt',
    'pt-BR': 'Offline — exibindo traduções salvas',
    ru: 'Офлайн — показываем сохранённые переводы',
    vi: 'Ngoại tuyến — đang hiển thị các bản dịch đã lưu',
  },
  partial: {
    en: 'Offline — showing saved translations; some text remains untranslated',
    ko: '오프라인 — 저장된 번역을 표시하고 있으며 일부 텍스트는 번역되지 않았습니다',
    id: 'Offline — menampilkan terjemahan tersimpan; sebagian teks belum diterjemahkan',
    it: 'Offline — traduzioni salvate visualizzate; parte del testo non è tradotta',
    nl: 'Offline — opgeslagen vertalingen worden weergegeven; een deel van de tekst is nog niet vertaald',
    ja: 'オフライン — 保存済みの翻訳を表示中です。一部のテキストは未翻訳です',
    'zh-CN': '离线 — 正在显示已保存的翻译；部分文本仍未翻译',
    'zh-TW': '離線 — 正在顯示已儲存的翻譯；部分文字仍未翻譯',
    es: 'Sin conexión — mostrando traducciones guardadas; parte del texto sigue sin traducir',
    fr: 'Hors ligne — traductions enregistrées affichées ; une partie du texte reste non traduite',
    de: 'Offline — gespeicherte Übersetzungen werden angezeigt; einige Texte bleiben unübersetzt',
    'pt-BR': 'Offline — exibindo traduções salvas; parte do texto continua sem tradução',
    ru: 'Офлайн — показываем сохранённые переводы; часть текста осталась без перевода',
    vi: 'Ngoại tuyến — đang hiển thị các bản dịch đã lưu; một số văn bản vẫn chưa được dịch',
  },
  missOnly: {
    en: 'Offline — no saved translations for this page',
    ko: '오프라인 — 이 페이지에 저장된 번역이 없습니다',
    id: 'Offline — tidak ada terjemahan tersimpan untuk halaman ini',
    it: 'Offline — nessuna traduzione salvata per questa pagina',
    nl: 'Offline — geen opgeslagen vertalingen voor deze pagina',
    ja: 'オフライン — このページの保存済み翻訳はありません',
    'zh-CN': '离线 — 此页面没有已保存的翻译',
    'zh-TW': '離線 — 此頁面沒有已儲存的翻譯',
    es: 'Sin conexión — no hay traducciones guardadas para esta página',
    fr: 'Hors ligne — aucune traduction enregistrée pour cette page',
    de: 'Offline — für diese Seite sind keine Übersetzungen gespeichert',
    'pt-BR': 'Offline — não há traduções salvas para esta página',
    ru: 'Офлайн — для этой страницы нет сохранённых переводов',
    vi: 'Ngoại tuyến — không có bản dịch đã lưu cho trang này',
  },
};

const TRANSLATION_UNAVAILABLE_LABELS = {
  en: 'Translation service unavailable — saved translations and local tools remain available',
  ko: '번역 서비스를 사용할 수 없습니다 — 저장된 번역과 로컬 도구는 계속 사용할 수 있습니다',
  id: 'Layanan terjemahan tidak tersedia — terjemahan tersimpan dan alat lokal tetap dapat digunakan',
  it: 'Servizio di traduzione non disponibile — le traduzioni salvate e gli strumenti locali restano disponibili',
  nl: 'Vertaalservice niet beschikbaar — opgeslagen vertalingen en lokale tools blijven beschikbaar',
  ja: '翻訳サービスを利用できません — 保存済みの翻訳とローカルツールは引き続き利用できます',
  'zh-CN': '翻译服务不可用 — 已保存的翻译和本地工具仍可使用',
  'zh-TW': '翻譯服務無法使用 — 已儲存的翻譯和本機工具仍可使用',
  es: 'Servicio de traducción no disponible — las traducciones guardadas y las herramientas locales siguen disponibles',
  fr: 'Service de traduction indisponible — les traductions enregistrées et les outils locaux restent disponibles',
  de: 'Übersetzungsdienst nicht verfügbar — gespeicherte Übersetzungen und lokale Werkzeuge bleiben verfügbar',
  'pt-BR': 'Serviço de tradução indisponível — traduções salvas e ferramentas locais continuam disponíveis',
  ru: 'Сервис перевода недоступен — сохранённые переводы и локальные инструменты остаются доступными',
  vi: 'Dịch vụ dịch thuật không khả dụng — các bản dịch đã lưu và công cụ cục bộ vẫn dùng được',
};
...
const BRIDGE_UNAVAILABLE_LABELS = {
  ...
  nl: 'AI-functies niet beschikbaar — vernieuw de pagina om het opnieuw te proberen',
...
const STORAGE_WARNING_LABELS = {
  ...
  nl: 'Opslag bijna vol — oude vertalingen worden automatisch verwijderd',
...
const TUTOR_OFFLINE_LABELS = {
  ...
  nl: 'De AI Tutor is offline niet beschikbaar. Controleer uw verbinding.',
...
const HISTORY_LABELS = {
  ...
  backToHistory: {
    en: 'Back to chat history',
    ko: '대화 기록으로 돌아가기',
    id: 'Kembali ke riwayat obrolan',
    it: 'Torna alla cronologia chat',
    nl: 'Terug naar de chatgeschiedenis',
    ja: '会話履歴に戻る',
    'zh-CN': '返回聊天记录',
    'zh-TW': '返回聊天記錄',
    es: 'Volver al historial',
    fr: 'Retour à l’historique',
    de: 'Zurück zum Chatverlauf',
    'pt-BR': 'Voltar ao histórico',
    ru: 'Вернуться к истории чата',
    vi: 'Quay lại lịch sử trò chuyện',
  },
  exportHistory: {
    en: 'Export history',
    ko: '기록 내보내기',
    id: 'Ekspor riwayat',
    it: 'Esporta cronologia',
    nl: 'Geschiedenis exporteren',
    ja: '履歴をエクスポート',
    'zh-CN': '导出记录',
    'zh-TW': '匯出記錄',
  ...
  deleteConfirm: {
    ...
    nl: 'Dit gesprek verwijderen?',
    ja: 'この会話を削除しますか？',
    'zh-CN': '删除此对话？',
    'zh-TW': '刪除此對話？',
    es: '¿Eliminar esta conversación?',
    fr: 'Supprimer cette conversation ?',
    de: 'Diese Unterhaltung löschen?',
    'pt-BR': 'Excluir esta conversa?',
    ru: 'Удалить этот разговор?',
    vi: 'Xóa cuộc trò chuyện này?',
  },
  clearConfirm: {
    en: 'Delete all Tutor history?',
    ko: '모든 튜터 기록을 삭제할까요?',
    id: 'Hapus semua riwayat Tutor?',
    it: 'Eliminare tutta la cronologia del Tutor?',
    nl: 'De volledige geschiedenis van de Tutor verwijderen?',
    ja: 'Tutorの履歴をすべて削除しますか？',
    'zh-CN': '删除所有导师记录？',
    'zh-TW': '刪除所有導師記錄？',
    es: '¿Eliminar todo el historial del Tutor?',
    fr: "Supprimer tout l'historique du Tutor ?",
    de: 'Den gesamten Tutor-Verlauf löschen?',
    'pt-BR': 'Excluir todo o histórico do Tutor?',
    ru: 'Удалить всю историю Tutor?',
    vi: 'Xóa toàn bộ lịch sử Tutor?',
  },
};
...
const POPUP_LABELS = {
  ...
  premiumTier: {
    ...
    nl: '\u2605 Zorgvuldig samengestelde terminologie',
    ja: '\u2605 厳選された用語',
    'zh-CN': '\u2605 精选术语',
    'zh-TW': '\u2605 精選術語',
  ...
  openSidebar: {
    ...
    nl: 'Zijbalk van AI Tutor openen',
    ja: 'AI\u30c1\u30e5\u30fc\u30bf\u30fc\u3092\u958b\u304f',
    'zh-CN': '\u6253\u5f00AI\u5bfc\u5e08\u4fa7\u680f',
    'zh-TW': '開啟AI導師側欄',
    es: 'Abrir tutor IA',
  ...
  autoTranslate: {
    ...
    nl: 'Automatisch vertalen bij het laden van de pagina',
    ko: '\ud398\uc774\uc9c0 \ub85c\ub4dc \uc2dc \uc790\ub3d9 \ubc88\uc5ed',
    ja: '\u30da\u30fc\u30b8\u8aad\u307f\u8fbc\u307f\u6642\u306b\u81ea\u52d5\u7ffb\u8a33',
    'zh-CN': '\u9875\u9762\u52a0\u8f7d\u65f6\u81ea\u52a8\u7ffb\u8bd1',
    'zh-TW': '頁面載入時自動翻譯',
  ...
  refreshPage: {
    ...
    nl: 'Vernieuw de Skilljar-pagina',
...
const ENGINE_LABELS = {
  ...
  cloudOption: {
    ...
    nl: 'Cloud — Claude (geen configuratie)',
    ja: 'クラウド — Claude（設定不要）',
  ...
  localOption: {
    ...
    nl: 'Lokaal — Ollama / op het apparaat',
  ...
  onDeviceHint: {
    ...
    nl: 'Draait op uw eigen computer via Ollama of een OpenAI-compatibele server. Er wordt niets naar de cloud verzonden. Vereist een actieve lokale server.',
  ...
  hardwareHint: {
    ...
    nl: 'Een model van ~4B (bijv. gemma3:4b) is de praktische keuze bij 16 GB RAM; modellen van 12B en groter hebben ~24 GB of meer nodig. Het eerste antwoord is trager doordat het model wordt geladen. De ingebouwde AI van Chrome wordt niet gebruikt — draai in plaats daarvan een lokale server.',
  ...
  signInTitle: {
    ...
    nl: 'Meld u aan om de AI Tutor te gebruiken',
  ...
  signInBody: {
    ...
    nl: 'De Tutor antwoordt via een gratis Puter-account. Vertaling en studiehulpmiddelen blijven zonder account werken.',
  ...
  signInLocalHint: {
    ...
    nl: 'Wilt u alles op uw apparaat houden? Kies de Tutor op uw apparaat via het SkillBridge-pictogram in de werkbalk.',
  ...
  statusOk: {
    ...
    nl: 'Verbonden met lokale server',
    ja: 'ローカルサーバーに接続しました',
    'zh-CN': '已连接到本地服务器',
    'zh-TW': '已連線到本地伺服器',
  ...
  statusCors: {
    ...
    nl: 'De server is bereikbaar, maar heeft het verzoek geblokkeerd. Start Ollama met OLLAMA_ORIGINS="chrome-extension://*" (of configureer dit op uw OpenAI-compatibele server).',
  ...
  statusUnreachable: {
    ...
    nl: 'Geen lokale server gevonden. Start Ollama (of uw lokale server) en controleer de URL.',
  ...
  tutorOff: {
    ...
    nl: 'De AI Tutor is uitgeschakeld. Schakel deze weer in via de SkillBridge-pop-up (AI Tutor-engine) om vragen te stellen.',
  ...
  tutorSignInRequired: {
    ...
    nl: 'Voor de AI Tutor moet u zich (gratis) bij Puter aanmelden. Verstuur uw vraag opnieuw en voltooi de aanmelding in het venster dat wordt geopend.',
  ...
  tutorLocalUnreachable: {
    ...
    nl: 'Uw lokale AI-server kon niet worden bereikt. Controleer of deze actief is en of het adres in de SkillBridge-pop-up klopt.',
  ...
  permDenied: {
    ...
    nl: 'Toestemming voor de lokale server is geweigerd. De lokale engine kan zonder deze toestemming niet worden uitgevoerd.',
...
const SHORTCUT_DESCRIPTIONS = {
  toggleSidebar: {
    ...
    nl: 'Leerzijbalk in- of uitschakelen',
    ja: '学習サイドバー切替',
    'zh-CN': '切换学习侧栏',
    'zh-TW': '切換學習側欄',
...
const FLASHCARD_LABELS = {
  ...
  allCaughtUp: {
    ...
    nl: 'Alles bijgewerkt — er valt nu niets te herhalen.',
  ...
  empty: {
    ...
    nl: 'Geen flashcards voor deze pagina',
    ja: 'このページの語彙はありません',
    'zh-CN': '此页面没有词汇',
    'zh-TW': '此頁面沒有詞彙',
...
const NOTE_LABELS = {
  ...
  placeholder: {
    ...
    nl: 'Schrijf een notitie over deze les…',
    ja: 'このレッスンについてメモを書く…',
    'zh-CN': '写下关于本课程的笔记…',
    'zh-TW': '寫下關於本課程的筆記…',
...
const REPORT_LABELS = {
  ...
  wrongPlaceholder: {
    ...
    nl: 'Wat is er verkeerd vertaald?',
    ja: 'どこが誤訳ですか?',
    'zh-CN': '哪里翻译错了?',
    'zh-TW': '哪裡翻譯錯了?',
  ...
  correctionPlaceholder: {
    ...
    nl: 'Wat zou er in plaats daarvan moeten staan? (optioneel)',
    ja: '正しくはどう訳すべきですか?(任意)',
    'zh-CN': '应该怎么翻译?(选填)',
    'zh-TW': '應該怎麼翻譯?(選填)',
  ...
  needsWork: {
    ...
    nl: 'Vertaling moet worden verbeterd',
    ja: '翻訳の改善が必要',
    'zh-CN': '翻译需要改进',
    'zh-TW': '翻譯需要改進',
...
const PDF_EXPORT_LABELS = {
  ...
  blocked: {
    ...
    nl: 'PDF-export is door uw browser geblokkeerd. Sta pop-ups voor deze site toe en probeer het opnieuw.',
...
const REFINE_LABELS = {
  refineLabel: {
    ...
    nl: 'Vertaling verfijnen (optioneel)',
    ja: '翻訳の推敲（任意）',
    'zh-CN': '翻译润色（可选）',
    'zh-TW': '翻譯潤飾（選填）',
  ...
  refineHint: {
    ...
    nl: "Google Translate geeft de pagina nog steeds eerst weer. Als dit is ingeschakeld, worden vertaalde alinea's bovendien naar een AI-model gestuurd voor correctie — en een correctie wordt verworpen tenzij elke term, elk getal, elke URL, elk codefragment en elke link ongewijzigd blijft.",
  ...
  refineConsent: {
    ...
    nl: 'Vertaalde cursustekst ter correctie naar een AI-model sturen',
  ...
  refineConsentHint: {
    ...
    nl: "Dit is een aparte keuze naast de AI Tutor. De Tutor verstuurt wat u typt; deze functie verstuurt alinea's die u leest. Uitgeschakeld totdat u dit zelf inschakelt.",
...
const BYOA_LABELS = {
  title: {
    ...
    nl: 'Een andere assistent vragen',
    ja: '別のアシスタントに聞く',
    'zh-CN': '询问其他助手',
    'zh-TW': '詢問其他助理',
  ...
  explain: {
    ...
    nl: 'SkillBridge stelt de prompt samen. U kopieert deze en plakt hem in de assistent die u al gebruikt — er wordt niets voor u verzonden.',
  ...
  questionPlaceholder: {
    ...
    nl: 'Wat wilt u vragen? (optioneel)',
    ja: '何を聞きたいですか？（任意）',
    'zh-CN': '你想问什么？（可选）',
    'zh-TW': '你想問什麼？（選填）',
  ...
  copyFailed: {
    ...
    nl: 'Kon niet kopiëren — selecteer de tekst hierboven en kopieer deze handmatig.',
  ...
  examNote: {
    ...
    nl: 'Deze pagina is een quiz. Antwoordopties worden niet in de prompt opgenomen.',
  ...
  selectionWithheld: {
    ...
    nl: 'Uw selectie was een antwoordoptie en is daarom weggelaten.',
  ...
  truncated: {
    ...
    nl: 'De prompt is ingekort om leesbaar te blijven.',
...
const BYOA_PROMPT_LABELS = {
  intro: {
    ...
    nl: 'Ik bestudeer een online les. Dit is de context.',
  ...
  selected: {
    ...
    nl: 'Het deel dat ik heb geselecteerd',
    ja: '選択した部分',
    'zh-CN': '我选中的部分',
    'zh-TW': '我選取的部分',
  ...
  examNote: {
    ...
    nl: 'Deze pagina is een quiz of toets. Geef me niet het antwoord. Leg alleen het onderliggende concept uit.',
  ...
  withheldNote: {
    ...
    nl: 'Mijn selectie is weggelaten omdat het een antwoordoptie op een toetspagina was.',
