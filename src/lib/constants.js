...
const SEND_LABELS = {
  'en': 'Send', 'ko': '전송', 'ja': '送信', 'zh-CN': '发送', 'zh-TW': '傳送',
  'es': 'Enviar', 'fr': 'Envoyer', 'de': 'Senden',
  'pt-BR': 'Enviar', 'ru': 'Отправить', 'vi': 'Gửi',
};

const ASK_TUTOR_LABELS = {
  'en': 'Ask Tutor', 'ko': '튜터에게 질문', 'ja': 'チューターに質問',
  'zh-CN': '问导师', 'zh-TW': '問導師', 'es': 'Preguntar', 'fr': 'Demander', 'de': 'Fragen',
  'pt-BR': 'Perguntar', 'ru': 'Спросить', 'vi': 'Hỏi gia sư',
};
...
const A11Y_LABELS = {
  toggleDark: {
    ...
    'zh-CN': '切换暗色模式', 'zh-TW': '切換暗色模式', 'es': 'Modo oscuro', 'fr': 'Mode sombre', 'de': 'Dunkelmodus',
    'pt-BR': 'Modo escuro', 'ru': 'Тёмный режим', 'vi': 'Chế độ tối',
  },
  chatHistory: {
    'en': 'Chat history', 'ko': '대화 기록', 'ja': '会話履歴',
    'zh-CN': '聊天记录', 'zh-TW': '聊天記錄', 'es': 'Historial', 'fr': 'Historique', 'de': 'Verlauf',
    'pt-BR': 'Histórico', 'ru': 'История чата', 'vi': 'Lịch sử trò chuyện',
  },
  closeSidebar: {
    'en': 'Close sidebar', 'ko': '사이드바 닫기', 'ja': 'サイドバーを閉じる',
    'zh-CN': '关闭侧栏', 'zh-TW': '關閉側欄', 'es': 'Cerrar panel', 'fr': 'Fermer le panneau', 'de': 'Panel schließen',
    'pt-BR': 'Fechar painel', 'ru': 'Закрыть панель', 'vi': 'Đóng thanh bên',
  },
  openTutor: {
    'en': 'Open AI Tutor', 'ko': 'AI 튜터 열기', 'ja': 'AIチューターを開く',
    'zh-CN': '打开AI导师', 'zh-TW': '開啟AI導師', 'es': 'Abrir tutor IA', 'fr': 'Ouvrir le tuteur IA', 'de': 'KI-Tutor öffnen',
    'pt-BR': 'Abrir tutor IA', 'ru': 'Открыть ИИ-репетитора', 'vi': 'Mở gia sư AI',
  },
  retry: {
    'en': 'Retry', 'ko': '재시도', 'ja': '再試行',
    'zh-CN': '重试', 'zh-TW': '重試', 'es': 'Reintentar', 'fr': 'Réessayer', 'de': 'Erneut versuchen',
    'pt-BR': 'Tentar novamente', 'ru': 'Повторить', 'vi': 'Thử lại',
  },
  loading: {
    'en': 'Loading', 'ko': '로딩 중', 'ja': '読み込み中',
    'zh-CN': '加载中', 'zh-TW': '載入中', 'es': 'Cargando', 'fr': 'Chargement', 'de': 'Laden',
    'pt-BR': 'Carregando', 'ru': 'Загрузка', 'vi': 'Đang tải',
  },
  backToChat: {
    'en': 'Back to chat', 'ko': '채팅으로 돌아가기', 'ja': 'チャットに戻る',
    'zh-CN': '返回聊天', 'zh-TW': '返回聊天', 'es': 'Volver al chat', 'fr': 'Retour au chat', 'de': 'Zurück zum Chat',
    'pt-BR': 'Voltar ao chat', 'ru': 'Вернуться в чат', 'vi': 'Quay lại trò chuyện',
  },
  removeQuote: {
    'en': 'Remove quote', 'ko': '인용 제거', 'ja': '引用を削除',
    'zh-CN': '移除引用', 'zh-TW': '移除引用', 'es': 'Eliminar cita', 'fr': 'Supprimer la citation', 'de': 'Zitat entfernen',
    'pt-BR': 'Remover citação', 'ru': 'Удалить цитату', 'vi': 'Xóa trích dẫn',
  },
};

const PROGRESS_LABELS = {
  'en': 'Translating…', 'ko': '번역 중…', 'ja': '翻訳中…',
  'zh-CN': '翻译中…', 'zh-TW': '翻譯中…', 'es': 'Traduciendo…', 'fr': 'Traduction…', 'de': 'Übersetzen…',
  'pt-BR': 'Traduzindo…', 'ru': 'Перевод…', 'vi': 'Đang dịch…',
};
...
const HISTORY_LABELS = {
  title: { 'en': 'Chat History', 'ko': '대화 기록', 'ja': '会話履歴', 'zh-CN': '聊天记录', 'zh-TW': '聊天記錄', 'es': 'Historial', 'fr': 'Historique', 'de': 'Verlauf', 'pt-BR': 'Histórico', 'ru': 'История чата', 'vi': 'Lịch sử trò chuyện' },
  loading: { 'en': 'Loading...', 'ko': '불러오는 중...', 'ja': '読み込み中...', 'zh-CN': '加载中...', 'zh-TW': '載入中...', 'es': 'Cargando...', 'fr': 'Chargement...', 'de': 'Laden...', 'pt-BR': 'Carregando...', 'ru': 'Загрузка...', 'vi': 'Đang tải...' },
  empty: { 'en': 'No conversations yet', 'ko': '대화 기록이 없습니다', 'ja': 'まだ会話がありません', 'zh-CN': '暂无对话', 'zh-TW': '暫無對話', 'es': 'Sin conversaciones', 'fr': 'Aucune conversation', 'de': 'Noch keine Gespräche', 'pt-BR': 'Nenhuma conversa ainda', 'ru': 'Пока нет бесед', 'vi': 'Chưa có cuộc trò chuyện nào' },
  clearHistory: { 'en': 'Clear History', 'ko': '기록 삭제', 'ja': '履歴を削除', 'zh-CN': '清除记录', 'zh-TW': '清除記錄', 'es': 'Borrar historial', 'fr': "Effacer l'historique", 'de': 'Verlauf löschen', 'pt-BR': 'Limpar histórico', 'ru': 'Очистить историю', 'vi': 'Xóa lịch sử' },
  historyCleared: { 'en': 'History cleared', 'ko': '기록이 삭제되었습니다', 'ja': '履歴を削除しました', 'zh-CN': '记录已清除', 'zh-TW': '記錄已清除', 'es': 'Historial borrado', 'fr': 'Historique effacé', 'de': 'Verlauf gelöscht', 'pt-BR': 'Histórico limpo', 'ru': 'История очищена', 'vi': 'Đã xóa lịch sử' },
};
...
const POPUP_LABELS = {
  targetLang: {
    ...
    'zh-CN': '目标语言', 'zh-TW': '目標語言', 'es': 'Idioma destino', 'fr': 'Langue cible', 'de': 'Zielsprache',
    'pt-BR': 'Idioma de destino', 'ru': 'Целевой язык', 'vi': 'Ngôn ngữ đích',
  },
  premiumTier: {
  ...
  openSidebar: {
    ...
    'zh-CN': '\u6253\u5f00AI\u5bfc\u5e08\u4fa7\u680f', 'zh-TW': '開啟AI導師側欄', 'es': 'Abrir tutor IA', 'fr': 'Ouvrir le tuteur IA', 'de': 'KI-Tutor \u00f6ffnen',
    'pt-BR': 'Abrir painel do tutor IA', 'ru': 'Открыть панель ИИ-репетитора', 'vi': 'Mở thanh bên gia sư AI',
  },
  autoTranslate: {
    'en': 'Auto-translate on page load', 'ko': '\ud398\uc774\uc9c0 \ub85c\ub4dc \uc2dc \uc790\ub3d9 \ubc88\uc5ed', 'ja': '\u30da\u30fc\u30b8\u8aad\u307f\u8fbc\u307f\u6642\u306b\u81ea\u52d5\u7ffb\u8a33',
    'zh-CN': '\u9875\u9762\u52a0\u8f7d\u65f6\u81ea\u52a8\u7ffb\u8bd1', 'zh-TW': '頁面載入時自動翻譯', 'es': 'Traducci\u00f3n autom\u00e1tica al cargar', 'fr': 'Traduction auto au chargement', 'de': 'Automatisch beim Laden \u00fcbersetzen',
    'pt-BR': 'Traduzir automaticamente ao carregar', 'ru': 'Автоперевод при загрузке страницы', 'vi': 'Tự động dịch khi tải trang',
  },
  englishOriginal: {
    'en': 'English (Original)', 'ko': 'English (Original)', 'ja': 'English (Original)',
    'zh-CN': 'English (Original)', 'zh-TW': 'English (Original)', 'es': 'English (Original)', 'fr': 'English (Original)', 'de': 'English (Original)',
    'pt-BR': 'English (Original)', 'ru': 'English (Original)', 'vi': 'English (Original)',
  },
  refreshPage: {
    'en': 'Please refresh the Skilljar page', 'ko': 'Skilljar \ud398\uc774\uc9c0\ub97c \uc0c8\ub85c\uace0\uce68\ud574\uc8fc\uc138\uc694', 'ja': 'Skilljar\u30da\u30fc\u30b8\u3092\u66f4\u65b0\u3057\u3066\u304f\u3060\u3055\u3044',
    'zh-CN': '\u8bf7\u5237\u65b0Skilljar\u9875\u9762', 'zh-TW': '請重新整理Skilljar頁面', 'es': 'Actualice la p\u00e1gina de Skilljar', 'fr': 'Veuillez actualiser la page Skilljar', 'de': 'Bitte Skilljar-Seite aktualisieren',
    'pt-BR': 'Atualize a página do Skilljar', 'ru': 'Обновите страницу Skilljar', 'vi': 'Vui lòng tải lại trang Skilljar',
  },
};
...
const SHORTCUT_LABELS = {
  title: {
    ...
    'zh-CN': '键盘快捷键', 'zh-TW': '鍵盤快捷鍵', 'es': 'Atajos de teclado', 'fr': 'Raccourcis clavier', 'de': 'Tastaturkürzel',
    'pt-BR': 'Atalhos de teclado', 'ru': 'Сочетания клавиш', 'vi': 'Phím tắt',
  },
};
...
const SHORTCUT_DESCRIPTIONS = {
  toggleSidebar: {
    ...
    'zh-CN': '切换AI导师', 'zh-TW': '切換AI導師', 'es': 'Abrir/cerrar tutor IA', 'fr': 'Ouvrir/fermer tuteur IA', 'de': 'KI-Tutor umschalten',
    'pt-BR': 'Abrir/fechar tutor IA', 'ru': 'Вкл/выкл ИИ-репетитора', 'vi': 'Bật/tắt gia sư AI',
  },
  toggleFlashcards: {
    'en': 'Vocabulary cards', 'ko': '어휘 카드', 'ja': '語彙カード',
    'zh-CN': '词汇卡片', 'zh-TW': '詞彙卡片', 'es': 'Tarjetas de vocabulario', 'fr': 'Cartes de vocabulaire', 'de': 'Vokabelkarten',
    'pt-BR': 'Cartões de vocabulário', 'ru': 'Карточки словаря', 'vi': 'Thẻ từ vựng',
  },
  toggleDarkMode: {
    'en': 'Toggle dark mode', 'ko': '다크 모드 전환', 'ja': 'ダークモード切替',
    'zh-CN': '切换暗色模式', 'zh-TW': '切換暗色模式', 'es': 'Modo oscuro', 'fr': 'Mode sombre', 'de': 'Dunkelmodus',
  ...
  showHelp: {
    ...
    'zh-CN': '显示快捷键', 'zh-TW': '顯示快捷鍵', 'es': 'Ver atajos', 'fr': 'Afficher raccourcis', 'de': 'Tastaturkürzel anzeigen',
    'pt-BR': 'Ver atalhos', 'ru': 'Показать сочетания', 'vi': 'Hiển thị phím tắt',
  },
  close: {
    'en': 'Close panel', 'ko': '패널 닫기', 'ja': 'パネルを閉じる',
    'zh-CN': '关闭面板', 'zh-TW': '關閉面板', 'es': 'Cerrar panel', 'fr': 'Fermer le panneau', 'de': 'Panel schließen',
    'pt-BR': 'Fechar painel', 'ru': 'Закрыть панель', 'vi': 'Đóng bảng',
  },
  focusChat: {
    'en': 'Focus chat input', 'ko': '채팅 입력 포커스', 'ja': 'チャット入力にフォーカス',
    'zh-CN': '聚焦聊天输入', 'zh-TW': '聚焦聊天輸入', 'es': 'Enfocar chat', 'fr': 'Focus sur le chat', 'de': 'Chat-Eingabe fokussieren',
    'pt-BR': 'Focar no chat', 'ru': 'Фокус на чат', 'vi': 'Chuyển đến ô nhập chat',
  },
};
...
const FLASHCARD_LABELS = {
  ...
  flip: {
    ...
    'zh-CN': '翻转', 'zh-TW': '翻轉', 'es': 'Voltear', 'fr': 'Retourner', 'de': 'Umdrehen',
    'pt-BR': 'Virar', 'ru': 'Перевернуть', 'vi': 'Lật',
  },
  next: {
    'en': 'Next', 'ko': '다음', 'ja': '次へ',
    'zh-CN': '下一个', 'zh-TW': '下一個', 'es': 'Siguiente', 'fr': 'Suivant', 'de': 'Weiter',
    'pt-BR': 'Próximo', 'ru': 'Далее', 'vi': 'Tiếp',
  },
  prev: {
    'en': 'Previous', 'ko': '이전', 'ja': '前へ',
    'zh-CN': '上一个', 'zh-TW': '上一個', 'es': 'Anterior', 'fr': 'Précédent', 'de': 'Zurück',
    'pt-BR': 'Anterior', 'ru': 'Назад', 'vi': 'Trước',
  },
  boxNew: {
    'en': 'New', 'ko': '새로운', 'ja': '新規',
    'zh-CN': '新', 'zh-TW': '新', 'es': 'Nuevo', 'fr': 'Nouveau', 'de': 'Neu',
    'pt-BR': 'Novo', 'ru': 'Новые', 'vi': 'Mới',
  },
  boxLearning: {
    'en': 'Learning', 'ko': '학습 중', 'ja': '学習中',
    'zh-CN': '学习中', 'zh-TW': '學習中', 'es': 'Aprendiendo', 'fr': 'En cours', 'de': 'Lernend',
    'pt-BR': 'Aprendendo', 'ru': 'Изучаемые', 'vi': 'Đang học',
  },
  mastered: {
    'en': 'Mastered', 'ko': '숙지 완료', 'ja': '習得済み',
    'zh-CN': '已掌握', 'zh-TW': '已掌握', 'es': 'Dominado', 'fr': 'Maîtrisé', 'de': 'Gelernt',
    'pt-BR': 'Dominado', 'ru': 'Изучено', 'vi': 'Đã thuộc',
  },
  reset: {
    'en': 'Reset Progress', 'ko': '진행 초기화', 'ja': '進捗リセット',
    'zh-CN': '重置进度', 'zh-TW': '重置進度', 'es': 'Reiniciar progreso', 'fr': 'Réinitialiser', 'de': 'Fortschritt zurücksetzen',
    'pt-BR': 'Reiniciar progresso', 'ru': 'Сбросить прогресс', 'vi': 'Đặt lại tiến trình',
  },
  empty: {
    'en': 'No vocabulary for this page', 'ko': '이 페이지의 어휘가 없습니다', 'ja': 'このページの語彙はありません',
    'zh-CN': '此页面没有词汇', 'zh-TW': '此頁面沒有詞彙', 'es': 'Sin vocabulario para esta página', 'fr': 'Aucun vocabulaire pour cette page', 'de': 'Kein Vokabular für diese Seite',
    'pt-BR': 'Sem vocabulário para esta página', 'ru': 'Нет словаря для этой страницы', 'vi': 'Không có từ vựng cho trang này',
  },
  openFlashcards: {
    'en': 'Vocabulary flashcards', 'ko': '어휘 플래시카드', 'ja': '語彙フラッシュカード',
    'zh-CN': '词汇闪卡', 'zh-TW': '詞彙閃卡', 'es': 'Tarjetas de vocabulario', 'fr': 'Cartes mémoire', 'de': 'Vokabel-Lernkarten',
    'pt-BR': 'Flashcards de vocabulário', 'ru': 'Карточки для запоминания', 'vi': 'Thẻ ghi nhớ từ vựng',
  },
};
