...
(function () {
  ...
  function getSidebarHTML() {
    ...
    return `
      ...
      <div class="si18n-tools-menu" id="si18n-tools-menu" role="menu" hidden>
        ...
        <button class="si18n-tools-item" id="si18n-report-btn" role="menuitem" type="button">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 9v4"/><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L14.71 3.86a2 2 0 0 0-3.42 0Z"/><path d="M12 17h.01"/></svg>
          <span>${sb.t(REPORT_LABELS.openReports)}</span>
        </button>
  ...
  function updateLocalizedLabels() {
    ...
    const menuItems = [
      ...
      ['si18n-report-btn', sb.t(REPORT_LABELS.openReports)],
